        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <p className="text-sm font-medium text-gray-600 mb-3 tracking-widest uppercase">Ekibimiz</p>
              <h2 className="text-4xl md:text-5xl font-serif font-light text-gray-900 mb-6">
                Başarının Arkasındaki İsimler
              </h2>
              <p className="text-gray-600 leading-relaxed max-w-2xl mx-auto">
                Tutkulu, deneyimli ve yaratıcı ekibimiz her projede mükemmellik için çalışıyor.
              </p>
            </div>
              ...
              {team.map((member, index) => (
                ...
                >
                  ...
                  <div className="p-6 text-center">
                    <h3 className="text-xl font-serif font-medium text-gray-900 mb-1">{member.name}</h3>
