        ...
        <div className="relative h-full flex items-center justify-center text-center px-4">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl text-white/95 leading-relaxed">
              Düğün, doğum günü, kurumsal davet veya özel kutlama… Her detay
              senin isteğine göre planlanır.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-600 leading-relaxed max-w-2xl mx-auto">
                ...
                Ambiyans, menü, masa düzeni ve müzik tercihleriniz
                doğrultusunda, hayalinizdeki atmosferi birlikte oluşturuyoruz.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-16 mb-16">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  Her etkinlik, sizin zevkinizi yansıtır. Konsept seçiminden
                  masa düzenine, dekorasyondan müziğe kadar her adımı sizinle
                  birlikte planlıyoruz.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  İster sade bir brunch, ister görkemli bir kutlama… Her detay
                  profesyonel ekibimiz tarafından özenle hazırlanır.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  Etkinliğinizin tarzına uygun menü seçenekleri sunuyoruz. Deniz
                  ürünlerinden et yemeklerine, atıştırmalıklardan tatlılara
                  kadar her kategoride özgün lezzetler.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  Servis planı ve masa düzeni, etkinliğin konseptine göre özel
                  olarak hazırlanır. Siz sadece keyfini çıkarın.
                </p>
              </div>
            </div>
