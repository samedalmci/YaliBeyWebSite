...
export default function MainClientCalendar() {
  ...
  const iconOptions = [
    ...
    {
      name: "Canlı Müzik Organizasyonu",
      value: "micvocal",
      Icon: MicVocal,
  ...
  const getIconColor = (iconName) =>
    iconOptions.find((i) => i.value === iconName)?.color || "bg-gray-400";
  const getEventIcon = (iconName) =>
    iconOptions.find((i) => i.value === iconName)?.Icon || Heart;
    ...
    const fetchEvents = async () => {
      ...
      try {
        ...
        const response = await fetch(
          `http://localhost:5000/events?month=${monthStr}`
        );
  ...
  const handleReservationEmailSend = () => {
    ...
    const subject = encodeURIComponent(
      `${eventKey} Tarihli Etkinlik Rezervasyon Talebi`
    );
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 leading-relaxed max-w-2xl mx-auto">
                Aşağıdaki takvimden rezerve edilmiş günleri görebilir ve müsait
                tarihleri kontrol edebilirsiniz. Herhangi bir güne tıklayarak
                rezervasyon talebi oluşturabilirsiniz.
              </p>
            </div>
                          ...
                          <div className="flex flex-wrap gap-1">
                            {dayEvents.slice(0, 3).map((event, idx) => {
                              ...
                              return (
                                <div
                                  key={idx}
                                  className={`h-5 w-5 rounded-full ${getIconColor(
                                    event.icon
          ...
          >
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 mb-4">
                Bu tarihte aşağıdaki etkinlikler mevcut:
              </p>
              ...
              <div className="space-y-2 mb-6">
                {selectedDayEvents.map((event, idx) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`h-8 w-8 rounded-full ${getIconColor(
                          event.icon
                        )} flex items-center justify-center shadow-sm`}
                      >
              ...
              <p className="text-sm text-gray-600 mb-6">
                Rezervasyon yapmak veya detaylı bilgi almak için bizimle
                iletişime geçin:
              </p>
            </div>
